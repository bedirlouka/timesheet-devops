...
// ''', cc: '', from: '', replyTo: '', subject: 'Succès de la pipeline DevOps Project timesheet-devops Bedirmalek', to: 'bedir.malek@esprit.tn'
...
Final Report: The pipeline has completed successfully. No action required''', cc: '', from: '', replyTo: '', subject: 'Succès de la pipeline DevOps Project timesheet-devops Bedirmalek', to: 'bedir.malek@esprit.tn'
            }
        }
    }
